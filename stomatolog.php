...
<main class="form-signin w-100 m-auto">
    ...
    <form action="zubarsnimi.php" method="post"> 
      <div class="form-floating">
        <input type="text" class="form-control"  placeholder="ime" name="ImeZubara">
        <label for="name">Ime</label>
      </div>
      <div class="form-floating">
        <input type="text" class="form-control"  placeholder="prezime" name="PrezimeZubara">
        <label for="name">Prezime</label>
      </div>
      <div class="form-floating">
        <input type="text" class="form-control"  placeholder="specijalizacija", name="Specijalizacija">
        <label for="name">Specijalizacija</label>
      </div>
      <div class="form-floating">
        <input type="text" class="form-control"  placeholder="telefon", name="TelefonZubara">
