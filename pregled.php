...
<html lang="en">
  <head>
    ...
    <title>Stomatoloska ordinacija - Unos pregleda</title>
...
<main class="form-signin w-100 m-auto">
    ...
    <form action="pregledsnimi.php" method="post"> 
    <div class="form-floating">
      <input type="text" class="form-control"  placeholder="IDZubara" name="IDZubara">
      <label for="name">IDZubara</label>
    </div>
    <div class="form-floating">
      <input type="text" class="form-control"  placeholder="IDPacijenta" name="IDPacijenta">
      <label for="name">IDPacijenta</label>
    </div>
    <div class="form-floating">
    ...
    <div class="form-floating">
      <input type="time" class="form-control"  placeholder="vreme" name="Vreme">
      <label for="name">Vreme</label>
    </div>
